...
export class AuditController {
  ...
  @ApiOperation({
    ...
    description:
      'Exige a permissão audit:read. Aceita filtros combináveis e paginação.',
  })
  ...
  @ApiOkResponse({
    description:
      'Logs encontrados. meta contém page, limit, totalItems, totalPages, hasNextPage e hasPreviousPage.',
  })
  @ApiUnauthorizedResponse({
